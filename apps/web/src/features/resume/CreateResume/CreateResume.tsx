...
const CreateResume = () => {
  ...
  return (
    <Button
      ...
      className="rcol bg-background hover:border-primary hover:text-primary relative flex h-72 w-44 cursor-pointer items-center justify-center gap-2 border-2 border-dashed border-neutral-300 transition-all"
      variant={"ghost"}
