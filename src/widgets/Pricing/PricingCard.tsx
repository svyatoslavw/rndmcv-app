...
export const PricingCard = memo(
  ({
    ...
    return (
      <Card className="flex h-full flex-col justify-start bg-gradient-to-br from-white via-zinc-50 to-zinc-200/70 dark:from-black dark:via-neutral-950 dark:to-neutral-900">
        <CardHeader>
